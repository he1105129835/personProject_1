...
@interface HNPTeamTwoVC ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.TeamTag == 0) {
        ...
        if ([self.delegate respondsToSelector:@selector(returnDataTwoWhenClick:returnClick:)]) {
            [self.delegate returnDataTwoWhenClick:self returnClick:paiMingModel];
        }
    }else if (self.TeamTag == 1){
