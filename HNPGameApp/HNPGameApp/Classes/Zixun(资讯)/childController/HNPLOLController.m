...
@interface HNPLOLController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation HNPLOLController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ziXunCell.zixunFabuNameLable.text = @"·英雄联盟·";
    return ziXunCell;
}
     ...
     AFHTTPSessionManager *manager = [AFHTTPSessionManager manager];
       [manager GET:@"http://api.yysc.online/user/talk/getTalkListByProject" parameters:@{
           ...
           for (HNPZixunModel *model in tempArray) {
               NSRange range = [model.content rangeOfString:@"英雄联盟"];
