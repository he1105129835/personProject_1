...
//            }
            ...
            mutiData.append(image.jpegData(compressionQuality: 0.8)!, withName: "file", fileName: "head.jpeg", mimeType: "image/jpeg")
...
//        let tool =
 ...
 @objc func postReturnString(_ urlString:String, fileName:String,image:UIImage?, viewcontroller:UIViewController?, params:[String:Any],success : @escaping (_ responseObject : Any)->(), failture : @escaping (_ error : Error)->()){
