...
@interface HNPPMLOLController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation HNPPMLOLController
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    if (section == 0) {
        ...
        HNPPaimingModel *tempModel = self.PaimingArray[1];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 0) {
            ...
            HNPPaimingModel *temp = _PaimingArray[1];
